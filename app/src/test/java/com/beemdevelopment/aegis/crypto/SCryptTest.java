...
public class SCryptTest {
    ...
    public void testTrailingNullCollision() throws EncodingException {
        ...
        SCryptParameters params = new SCryptParameters(
                CryptoUtils.CRYPTO_SCRYPT_N, CryptoUtils.CRYPTO_SCRYPT_p, CryptoUtils.CRYPTO_SCRYPT_r, salt);
        ...
        for (int i = 0; i < 128; i += 4) {
            ...
            // once the length of the input is over 64 bytes, trailing nulls do not cause a
            // collision anymore
