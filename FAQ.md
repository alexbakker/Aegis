...
We don't have influence over when the new version is released on F-Droid. Once
we've released it on GitHub, F-Droid will usually kick off their build process a
day later and publish the app to their repository a couple of days afterwards.
It can sometimes take up to a week for a new version to appear on F-Droid.
